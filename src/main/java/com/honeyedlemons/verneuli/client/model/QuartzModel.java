...
public class QuartzModel extends AbstractGemModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -7.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(68, 23).addBox(-4.0F, -7.0F, -4.5F, 8.0F, 8.0F, 2.0F, new CubeDeformation(0.26F))
        ...
        PartDefinition hat = head.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(56, 0).addBox(-7.0F, -5.0F, -2.0F, 3.0F, 4.0F, 4.0F, new CubeDeformation(0.25F))
                ...
                .texOffs(69, 16).addBox(-2.0F, -9.0F, -6.5F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    public void setupAnim(GemRenderState renderState) {
        ...
        if (renderState.rightArmPose == ArmPose.CROSSBOW_CHARGE) {
            AnimationUtils.animateCrossbowCharge(
                    this.rightArm, this.leftArm, renderState.maxCrossbowChargeDuration, renderState.ticksUsingItem, renderState.mainArm == HumanoidArm.RIGHT
            );
        }
